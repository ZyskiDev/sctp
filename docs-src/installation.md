...
Minecraft version 1.21.11 and 26.1 are no longer supported as of version 1.6, but older downloads are still available for Fabric.
:::
...
![1](./i1.png)
::: tip I: Please select the Minecraft version. For the SCTP mod, select 26.2 or 26.3.
:::
...
![alt text](i3.png)
::: tip I: Select the same game version you picked during the installation process, in this case 26.2 or 26.3.
:::
...
::: tip I: Select the correct game version (26.2 or 26.3) and put it in a place to remember for later.
:::
![alt text](i4.png)
::: info Safety
...
:::
### Downloading & running the installer
Start by downloading and running the [official Neoforge installer](https://neoforged.net/). 
::: tip Please select the correct Minecraft version on the website - 26.2 or 26.3
:::
::: tip Please select the most recent loader version available, usually selected by default.
:::
After opening the installer, make sure to:
::: tip Select 'Install client'
:::
::: tip Keep the directory the same if you use the normal MC launcher without changing the location.
:::
After letting the installer do it's work, Neoforge will be installed succesfully!
### Launching Minecraft
Run the new profile created by the launcher first, so it can make the mods folder. Make sure the correct profile is selected (Neoforge-XXX-loader-XXX, or similar) and press play.
![2](./i2.png)
## Downloading the SCTP mod
Next, we will download the SCTP mod, called shoplogger. You can download it by going to the [sctp homepage](https://sctp.nl/) and pressing the Download button. 
::: tip I: Select the correct game version (26.2 or 26.3) and put it in a place to remember for later. Make sure to select Neoforge.
:::
![alt text](i4.png)
::: info Safety
If you want to confirm the source code yourself before downloading, you can check out the [github repository](https://github.com/maxolotled/sctp).
...
For the last step, we need to put the mod files into the directory of the Fabric installation we made. Start by navigating to where you put the two downloaded mod files.
![alt text](i5.png)
::: tip I: Copy the SCTP mod file you just downloaded.
:::
::: tip II: Navigate to the mod directory by pasting `%appdata%\.minecraft\mods` in your navigator bar (marked with the arrow), or open the folder via your launcher
:::
::: tip III: Paste the files into this mods folder.
