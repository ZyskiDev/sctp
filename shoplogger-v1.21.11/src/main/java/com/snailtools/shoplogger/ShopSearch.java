...
public final class ShopSearch {
	...
	public static void searchAsync(MinecraftClient client, String query) {
		String q = query.trim();
		if (q.isEmpty()) {
	...
	private static void handleResponse(MinecraftClient client, String query, ShopWorld world, HttpResponse<String> response) {
	...
	private static void message(MinecraftClient client, Formatting color, String text) {
